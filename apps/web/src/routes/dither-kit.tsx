...
function Select<T extends string>({
	...
	return (
		<select
			...
			className="rounded-md border bg-card px-2 py-1.5 font-mono text-foreground text-xs transition-colors hover:border-foreground/25"
		>
			{options.map((o) => (
	...
	return (
		...
		>
			<div className="flex items-center justify-between border-b px-5 py-4">
				<span className="font-pixel-geist text-foreground text-sm">
					tweak the charts
				</span>
				<button
					type="button"
			...
			<div className="flex gap-2 border-t px-5 py-4">
				<button
					type="button"
					onClick={onReplayAll}
					className="flex flex-1 items-center justify-center gap-2 rounded-md bg-primary px-3 py-2 font-mono text-primary-foreground text-xs transition-opacity hover:opacity-90"
				>
					<RefreshCcwIcon className="size-3.5" />
					replay all
				</button>
				<button
					...
					className="rounded-md border px-3 py-2 font-mono text-muted-foreground text-xs transition-colors hover:text-foreground"
				>
					reset
				</button>
			</div>
				...
				<div className="flex flex-col gap-14">
					<div className="flex items-center gap-3">
						...
						<button
							...
							className="flex items-center gap-2 rounded-md bg-primary px-3 py-1.5 font-mono text-primary-foreground text-xs transition-opacity hover:opacity-90"
						>
